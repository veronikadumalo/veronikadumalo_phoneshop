...
fclose($fd); 
    ...
    $result2=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '11'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple1'])){
            ...
            $result3=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '12'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple2'])){
         ...
         $result4=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '13'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple3'])){
         ...
         $result5=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '14'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple4'])){
         ...
         $result6=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '15'");
