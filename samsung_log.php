...
fclose($fd); 
    ...
    $result2=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '1'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple1'])){
            ...
            $result3=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '2'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple2'])){
         ...
         $result4=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '3'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple3'])){
         ...
         $result5=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '4'");
   ...
   <hr style='border-width: 2px '>";
        ...
        if(isset($_POST['add_apple4'])){
         ...
         $result6=mysqli_query($conn, "SELECT * FROM `phone` WHERE `id` = '5'");
